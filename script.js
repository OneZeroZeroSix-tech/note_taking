...
const setCanvasBackground = () => {
	...
	ctx.fillStyle = selectedColor; //setting fillStyle back to the selectedColor, it'll be in the brush color
}
...
const drawRect = (e) => {
	//if fillColor isn't checked draw a rect with border else draw rest with background
